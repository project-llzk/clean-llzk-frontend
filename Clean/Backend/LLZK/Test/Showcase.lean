...
#guard Showcase.totalVectors == 33
#guard Showcase.sourceBacked == 6
#guard Corpus.corpus.size == 12
#guard Corpus.corpus.all fun entry => (Showcase.purpose entry.name).isSome
#guard Corpus.corpus.map (·.name) ==
  #[ "Multiply", "Decompose", "Addition8FullCarry", "Passthrough", "ConstOut", "CopyCell"
